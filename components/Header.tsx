...
const Header: React.FC<HeaderProps> = ({ 
    ...
    return (
        <header className={`sticky top-0 z-50 w-full border-b backdrop-blur-md px-6 py-4 transition-colors duration-300 ${
            darkMode 
                ...
                <div className="hidden md:flex flex-1 max-w-lg"> 
                    <label className="relative flex w-full items-center">
                        <div className={`absolute inset-y-0 left-0 flex items-center pl-4 ${
                            darkMode ? 'text-[#9db9a6]' : 'text-gray-400'
                        }`}>
                        ...
                        <input
                            ...
                            className={`h-12 w-full rounded-full border-none pl-12 pr-4 focus:ring-2 focus:ring-primary/50 transition-all focus:outline-none ${
                                darkMode 
                                    ? 'bg-[#28392e] text-white placeholder-[#9db9a6]' 
                ...
                <div className="flex items-center gap-6">
                    <div className="hidden lg:flex items-center gap-6">
                        <button onClick={onGoHome} className={`text-sm font-medium transition-colors ${
                            darkMode ? 'text-gray-300 hover:text-primary' : 'text-gray-600 hover:text-primary'
                        }`}>Inicio</button>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button 
                            ...
                            className={`flex h-10 w-10 items-center justify-center rounded-full transition-colors ${
                                darkMode 
                                    ? 'bg-[#28392e] text-yellow-400 hover:bg-[#344a3b]' 
