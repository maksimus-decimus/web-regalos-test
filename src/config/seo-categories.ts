...
export const SEO_CATEGORIES_NINOS: SEOCategory[] = [
  {
    ...
    parent: 'ninos',
    icon: 'toys',
    metaTitle: 'Regalos para Niños 2026 | Gran Selección de Juguetes',
    metaDescription: 'Descubre los mejores regalos para niños. Juguetes educativos, divertidos y seguros para todas las edades.',
    keywords: ['regalos niños', 'juguetes niños', 'regalo infantil'],
  },
  {
    id: 'ninos-10-anos',
    name: 'Regalos para niños de 10 años',
    slug: 'regalos-ninos-10-anos',
    parent: 'ninos',
    icon: 'cake',
    metaTitle: 'Regalos para Niños de 10 Años | Ideas de Cumpleaños',
    metaDescription: 'Los mejores regalos para niños de 10 años. Ideas de cumpleaños educativas y divertidas.',
    keywords: ['regalo niño 10 años', 'cumpleaños 10', 'regalo preadolescente'],
  },
  {
    id: 'ninos-educativos',
    ...
    parent: 'ninos',
    icon: 'school',
    metaTitle: 'Juguetes Educativos para Niños | Aprender Jugando',
    metaDescription: 'Juguetes educativos que estimulan el aprendizaje. Kits STEM, ciencia y construcción para niños.',
    keywords: ['juguetes educativos', 'STEM niños', 'aprender jugando'],
  },
  {
    id: 'ninos-originales',
    ...
    parent: 'ninos',
    icon: 'redeem',
    metaTitle: 'Regalos Originales para Niños | Ideas Únicas y Sorprendentes',
    metaDescription: 'Regalos originales y únicos para niños. Ideas sorprendentes que los niños adorarán.',
    keywords: ['regalo original niño', 'ideas únicas', 'sorpresa infantil'],
  },
  {
    id: 'ninos-5-anos',
    name: 'Qué regalar a un niño de 5 años',
    slug: 'que-regalar-nino-5-anos',
    parent: 'ninos',
    icon: 'child_care',
    metaTitle: '¿Qué Regalar a un Niño de 5 Años? Ideas Especiales',
    metaDescription: 'Ideas de regalos perfeccion ados para niños de 5 años. Juguetes seguros y educativos.',
    keywords: ['regalo niño 5 años', 'cumpleaños 5', 'juguetes edad 5'],
  },
  {
    id: 'ninos-8-anos',
    name: 'Regalos para niños de 8 años',
    slug: 'regalos-ninos-8-anos',
    parent: 'ninos',
    icon: 'cake',
    metaTitle: 'Regalos para Niños de 8 Años | Ideas de Regalo',
    metaDescription: 'Los mejores regalos para niños de 8 años. Ideas educativas y entretenidas para esta edad.',
    keywords: ['regalo niño 8 años', 'cumpleaños 8', 'juguetes 8 años'],
  },
  {
    id: 'ninos-construccion',
    name: 'Juguetes de construcción para niños',
    slug: 'juguetes-construccion',
    parent: 'ninos',
    icon: 'home_repair_service',
    metaTitle: 'Juguetes de Construcción para Niños | Bloques y Sets',
    metaDescription: 'Juguetes de construcción magnéticos y modulares. Bloques, piezas y kits para construir infinitamente.',
    keywords: ['bloques construcción', 'juguetes construcción', 'LEGO alternativas'],
  },
  {
    id: 'ninos-comunion',
    name: 'Regalos para niños comunión',
    slug: 'regalos-comunion-ninos',
    parent: 'ninos',
    icon: 'celebration',
    metaTitle: 'Regalos para Comunión Niños | Ideas Especiales',
    metaDescription: 'Regalos elegantes para comuniones de niños. Ideas significativas para este momento especial.',
    keywords: ['regalo comunión', 'comunión niño', 'regalo especial'],
  },
  {
    id: 'ninos-juegos-mesa-6',
    name: 'Juegos de mesa para niños 6 años',
    slug: 'juegos-mesa-6-anos',
    parent: 'ninos',
    icon: 'games',
    metaTitle: 'Juegos de Mesa para Niños de 6 Años | Diversión Familiar',
    metaDescription: 'Juegos de mesa educativos y divertidos para niños de 6 años. Entretenimiento en familia garantizado.',
    keywords: ['juegos mesa 6 años', 'juegos familia', 'entretenimiento infantil'],
  },
  {
    id: 'ninos-dinosaurios',
    name: 'Regalos para niños que aman los dinosaurios',
    slug: 'regalos-dinosaurios',
    parent: 'ninos',
    icon: 'pets',
    metaTitle: 'Regalos de Dinosaurios para Niños | Colecciones Realistas',
    metaDescription: 'Regalos temáticos de dinosaurios. Figuras realistas, libros y juguetes para niños fanáticos.',
    keywords: ['dinosaurios niños', 'figuras dinosaurios', 'Regalo dino'],
  },
  {
    id: 'ninos-robots',
    ...
    parent: 'ninos',
    icon: 'smart_toy',
    metaTitle: 'Robots para Niños | Educativos y Programables',
    metaDescription: 'Robots educativos y programables para niños. Aprende robótica y codificación jugando.',
    keywords: ['robot niño', 'robot educativo', 'programación niños'],
  },
  {
    id: 'ninos-deportivos',
    name: 'Regalos deportivos para niños',
    slug: 'regalos-deportivos-ninos',
    parent: 'ninos',
    icon: 'sports',
    metaTitle: 'Regalos Deportivos para Niños | Activos y Saludables',
    metaDescription: 'Equipamiento deportivo para niños. Fomenta actividades al aire libre y ejercicio físico.',
    keywords: ['regalo deportivo niño', 'equipo deporte', 'niños activos'],
  },
  {
    id: 'ninos-ciencia',
    name: 'Kits de ciencia para niños',
    slug: 'kits-ciencia-ninos',
    parent: 'ninos',
    icon: 'science',
    metaTitle: 'Kits de Ciencia para Niños | Experimentos Educativos',
    metaDescription: 'Kits completos de ciencia y experimentos para niños. Aprende física, química y biología jugando.',
    keywords: ['kit ciencia', 'experimentos niños', 'ciencia educativa'],
  },
  {
    id: 'ninos-reyes',
    name: 'Regalos de Reyes para niños',
    slug: 'regalos-reyes-ninos',
    parent: 'ninos',
    icon: 'card_giftcard',
    metaTitle: 'Regalos de Reyes para Niños | Magia y Sorpresa',
    metaDescription: 'Regalos especiales para la llegada de los Reyes Magos. Sorpresas mágicas para niños.',
    keywords: ['regalo Reyes', 'Reyes Magos', 'sorpresa niño'],
  },
  {
    id: 'ninos-exterior',
    name: 'Juguetes para exterior niños',
    slug: 'juguetes-exterior-ninos',
    parent: 'ninos',
    icon: 'nature',
    metaTitle: 'Juguetes para Exterior Niños | Diversión al Aire Libre',
    metaDescription: 'Juguetes resistentes para exterior. Diversión en el jardín, parque y naturaleza.',
    keywords: ['juguetes exterior', 'juegos al aire libre', 'jardín niños'],
  },
  {
    id: 'ninos-12-anos',
    name: 'Regalos para niños de 12 años',
    slug: 'regalos-ninos-12-anos',
    parent: 'ninos',
    icon: 'cake',
    metaTitle: 'Regalos para Niños de 12 Años | Preadolescentes',
    metaDescription: 'Regalos para niños de 12 años. Ideas para preadolescentes entre tecnología y entretenimiento.',
    keywords: ['regalo 12 años', 'preadolescente', 'tecnología niño'],
  },
  {
    id: 'ninos-tecnologia',
    name: 'Regalos tecnológicos para niños',
    slug: 'regalos-tech-ninos',
    parent: 'ninos',
    icon: 'devices',
    metaTitle: 'Regalos Tecnológicos para Niños | Gadgets Modernos',
    metaDescription: 'Tecnología educativa de punta para niños. Gadgets seguros y didácticos.',
    keywords: ['regalo tech niño', 'gadgets educativos', 'tecnología infantil'],
  },
  {
    id: 'ninos-stem',
    ...
    parent: 'ninos',
    icon: 'lab',
    metaTitle: 'Juguetes STEM España | Educación Tecnológica',
    metaDescription: 'Juguetes STEM diseñados para niños españoles. Ciencia, tecnología, ingeniería y matemáticas.',
    keywords: ['STEM España', 'juguetes STEM', 'educación tecnológica'],
  },
  {
    id: 'ninos-creativos',
    name: 'Regalos para niños creativos',
    slug: 'regalos-ninos-creativos',
    parent: 'ninos',
    icon: 'palette',
    metaTitle: 'Regalos para Niños Creativos | Arte y Manualidades',
    metaDescription: 'Regalos para estimular la creatividad. Kits de arte, pintura y manualidades para niños.',
    keywords: ['creatividad niño', 'arte infantil', 'manualidades'],
  },
  {
    id: 'ninos-disfraces',
    name: 'Disfraces originales para niños',
    slug: 'disfraces-ninos',
    parent: 'ninos',
    icon: 'theater_comedy',
    metaTitle: 'Disfraces Originales para Niños | Carnaval y Fiestas',
    metaDescription: 'Disfraces creativos y originales para niños. Carnaval, fiestas temáticas y celebraciones.',
    keywords: ['disfraces niños', 'carnaval', 'fiesta temática'],
  },
  {
    id: 'ninos-baratos',
    name: 'Regalos baratos para cumpleaños niños',
    slug: 'regalos-baratos-ninos',
    parent: 'ninos',
    icon: 'savings',
    metaTitle: 'Regalos Baratos para Cumpleaños Niños | Económicos',
    metaDescription: 'Regalos económicos pero especiales para cumpleaños de niños. Diversión sin gastar mucho.',
    keywords: ['regalo barato niño', 'cumpleaños económico', 'presupuesto limitado'],
  },
];
...
export const SEO_CATEGORIES_MAP = new Map<string, SEOCategory>(
  [...SEO_CATEGORIES_PADRES, ...SEO_CATEGORIES_NINOS].map(cat => [cat.slug, cat])
);
